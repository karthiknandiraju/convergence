...
def save_outputs(rows, runtimes, pools, args, output_dir: Path) -> None:
    ...
    manifest = {
        ...
        "method": METHOD,
        "method_label": METHOD_LABEL,
        "design": "four_retired_pools_latest_environment_reward_only_v5",
        "candidate_process_present": False,
        "promotion_process_present": False,
        "eviction_process_present": False,
...
def main() -> None:
    ...
    args.design_version = "four_retired_pools_latest_environment_reward_only_v5"
    ...
    print("Retired pool member: environment-reward pool-value argmax")
