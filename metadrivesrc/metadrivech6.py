#!/usr/bin/env python3
"""MetaDrive Chapter 6 DQN experiment: Median 50.
...
* Median 50 uses ordinary step-wise exploration plus two memory-light
  schedules. The lowest-Q action is forced on the episode/step anti-diagonal
  and on the first step of the final training episode. The maximum-Q action
  is forced on the main diagonal and final planned episode/step. All remaining
  steps use ordinary Median 50.
...
def select_training_action(
    ...
    if experiment == "median_50":
        ...
        if (
            ...
            return agent.greedy_action(state), "median50_max_q_final"
...
def parse_args():
    ...
    default_output_dir = script_dir.parent / "ch6results_42"
...
def main() -> None:
    ...
    print("Median 50 final episode/final action uses maximum-Q action: yes")
    print("Median 50 anti-diagonal uses lowest-Q action: yes")
    print("Median 50 final episode/first step uses lowest-Q action: yes")
