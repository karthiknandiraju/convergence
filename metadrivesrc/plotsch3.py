...
reads ``../ch3results_42/all_episode_results.csv`` and writes JPEG files to
``../ch3results_42/plots``.
"""
...
def arguments() -> argparse.Namespace:
    ...
    default_results = script_dir.parent / "ch3results_42"
...
def load_results(results_dir: Path) -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    if not csv_path.exists():
        raise FileNotFoundError(
            ...
            "folder or pass --results-dir /path/to/ch3results_42."
        )
