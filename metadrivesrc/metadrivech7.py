#!/usr/bin/env python3
"""MetaDrive Chapter 7 DQN experiment: Median 50.
...
* Median 50 uses ordinary step-wise exploration plus one memory-light
  schedule. The lowest-Q action is forced on the episode/step anti-diagonal
  and on the first step of the final training episode. All remaining steps
  use ordinary Median 50.
...
def parse_args():
    ...
    default_output_dir = script_dir.parent / "ch7results_42"
