...
python run_seed_policy_comparison.py --seed 5 --policy-files policies/metadrivech67.py --policy-names ch67 --device cuda --skip-policy-training
...
python -u "compare_collision_policies.py" --seed 7 --output-dir comparisons/seed_7/all_policies_timed 

python -u "compare_safety_policies.py" --seed 38 --output-dir comparisons/seed_17/all_policies_timed 


## policy Run Command 

python -u policies/Karthikeya27adv67.py --seed 7 --test-seed 100000 --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda

python -u policies/metadrivech6b.py --seed 3 --test-seed 100000 --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda

python -u policies/metadrivech67.py --seed 13 --test-seed 100000 --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda

python -u policies/Karthikeya6786.py --seed 3 --test-seed 100000 --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda

python -u policies/Karthikeya27adv8.py --seed 17 --test-seed 100000 --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda
...
PYTHONHASHSEED=5 CUBLAS_WORKSPACE_CONFIG=:4096:8 python -u train_canonical_baselines.py --seed 5 --methods epsilon noisy rnd --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda --output-root canonical_baselines_timed


PYTHONHASHSEED=3 CUBLAS_WORKSPACE_CONFIG=:4096:8 python -u train_canonical_baselines.py --seed 3 --methods epsilon noisy rnd --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda --output-root canonical_baselines_timed

PYTHONHASHSEED=7 CUBLAS_WORKSPACE_CONFIG=:4096:8 python -u train_canonical_baselines.py --seed 7 --methods epsilon noisy rnd --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda --output-root canonical_baselines_timed

PYTHONHASHSEED=13 CUBLAS_WORKSPACE_CONFIG=:4096:8 python -u train_canonical_baselines.py --seed 13 --methods epsilon noisy rnd --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda --output-root canonical_baselines_timed


PYTHONHASHSEED=13 CUBLAS_WORKSPACE_CONFIG=:4096:8 python -u train_canonical_baselines.py --seed 13 --methods epsilon noisy rnd --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda --output-root canonical_baselines_timed

PYTHONHASHSEED=38 CUBLAS_WORKSPACE_CONFIG=:4096:8 python -u train_canonical_baselines.py --seed 38 --methods epsilon noisy rnd --train-episodes 500 --test-episodes 300 --max-episode-steps 500 --device cuda --output-root canonical_baselines_timed
