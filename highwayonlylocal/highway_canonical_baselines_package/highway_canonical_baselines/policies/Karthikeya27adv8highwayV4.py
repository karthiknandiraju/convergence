#!/usr/bin/env python3
"""HighwayEnv Karthikeya27adv8highwayV4 DQN with retained safety evidence.
...
Training policy
---------------
* Policy name: Karthikeya27adv8highwayV4.
...
* After the initial pass, a RETIRED pool deterministically chooses the
  ...
  passes already provide action diversity, so V4 adds no post-pass random action.
...
* Candidate reception uses Highway-specific limits: 400 soft, 500 hard, and
  bounded batch eviction of 50 by default. The larger recyclable store directly
...
* After a 100-state pure-DQN calibration period, general and safety normalizers/
  ...
  collision RMST from 14.92 to 9.90, so V4 retains the better-supported
...
* A candidate is promoted after two visits by default. The V4 lifecycle
...
* Hazard memory uses 75% of permanent capacity (375 records by default).
  The larger archive retains blocked-action evidence while the V4 candidate
...
EXPERIMENTS = ["Karthikeya27adv8highwayV4"]
SHORT_LABELS = {
    "Karthikeya27adv8highwayV4": "Karthikeya27adv8highwayV4",
}
COLORS = {
    "Karthikeya27adv8highwayV4": "#2ca02c",
}

POLICY_NAME = "Karthikeya27adv8highwayV4"
OBSERVATION_SOURCE = (
...
# ---------------------------------------------------------------------------
# Karthikeya27adv8highwayV4 unified lifecycle and action-status masks
# ---------------------------------------------------------------------------
...
class SimilarStateActionPools:
    """Karthikeya27adv8highwayV4 lifecycle memory with bounded retained hazard evidence."""
...
def select_training_action(
    ...
    if experiment != "Karthikeya27adv8highwayV4":
        raise ValueError(f"Unknown experiment: {experiment}")

    q_values = agent.q_values(state)
    tie_key = f"train|Karthikeya27adv8highwayV4|{episode}|{step}"
    pooling_limit = int(
...
def run_experiment(
    ...
    if action_count != 9:
        train_env.close()
        raise RuntimeError(
            f"Karthikeya27adv8highwayV4 expects exactly 9 discrete actions; environment has {action_count}."
        )
    action_pools = SimilarStateActionPools(
...
def primary_outcome_summary(
    ...
    """Return the two focused V4 outcomes without auxiliary metrics."""
    episodes = len(rows)
...
def save_framework_compatibility_outputs(
    ...
    nested_model = output_dir / "models" / "Karthikeya27adv8highwayV4_model.pt"
...
def write_completion_manifest(
    ...
    safety_memory_path = (
        output_dir / "models" / "Karthikeya27adv8highwayV4_safety_memory.pkl"
    )
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "HighwayEnv Karthikeya27adv8highwayV4: Karthikeya20 baseline with retained "
    ...
    parser.add_argument(
        ...
        default=400,
        help=(
            "Highway V4 soft candidate reception limit. Default: 400."
        ),
    )
    parser.add_argument(
        ...
        help=(
            ...
            "is reached. Highway V4 default: 500."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "pool. Highway V4 default: 2; one-visit records remain recyclable."
        ),
    )
    parser.add_argument(
        ...
        help=(
            ...
            "V4 default 0.75 gives 375 hazards for 500 pools."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "two-step outcome to count toward SAFE. Highway V4 default: 0.0."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "DQN-plus-safety can start. Highway V4 default: 100."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "candidate. V4 default: 0.85; permanent safety gates stay strict."
        ),
    )
    parser.add_argument(
        ...
        help=(
            ...
            "V4 default: 0.50; candidate safety RMS remains capped at 0.30."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "<output-root>/seed_<seed>/Karthikeya27adv8highwayV4."
        ),
    )
    parser.add_argument(
        "--output-dir",
        ...
        help=(
            ...
            "equal <output-root>/seed_<seed>/Karthikeya27adv8highwayV4."
        ),
    )
    ...
    if output_dir.exists():
        ...
        if has_contents and not force:
            raise FileExistsError(
                f"Karthikeya27adv8highwayV4 output directory is not empty: {output_dir}. "
...
def main() -> None:
    ...
    args.hybrid_design_version = (
        "karthikeya27adv8highwayv4_seed17_focused_candidate_reception_v1"
    )
    ...
    print("=" * 76)
    print("HIGHWAYENV KARTHIKEYA27ADV8HIGHWAYV4 RETAINED-EVIDENCE SAFETY POLICY")
    print("=" * 76)
    ...
    print("Policy name: Karthikeya27adv8highwayV4")
    ...
    print("Policy folder name: Karthikeya27adv8highwayV4")
